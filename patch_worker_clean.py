...
def modify_file(filepath):
    ...
    # We need to remove the lines referencing EpubFilePath, CoverImagePath, SyncMap, Annotations, AudioTracks
    new_worker = '''using System;
using System.IO;
...
modify_file('QuimeraReader.Clients/QuimeraReader.Mobile/Services/MauiOfflineSyncWorker.cs')